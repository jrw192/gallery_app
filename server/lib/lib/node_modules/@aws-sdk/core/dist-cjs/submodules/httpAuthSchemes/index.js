...
var resolveAwsSdkSigV4Config = /* @__PURE__ */__name(config => {
  ...
  if (!normalizedCreds) {
    if (config.credentialDefaultProvider) {
      normalizedCreds = (0, import_core.normalizeProvider)(config.credentialDefaultProvider(Object.assign({}, config, {
  ...
  if (config.signer) {
    ...
    signer = /* @__PURE__ */__name(() => (0, import_core.normalizeProvider)(config.region)().then(async region => [(await config.regionInfoProvider(region, {
