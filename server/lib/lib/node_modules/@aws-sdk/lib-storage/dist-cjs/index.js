...
var _Upload = class _Upload extends import_events.EventEmitter {
  ...
  async __uploadUsingPut(dataPart) {
    ...
    if (!endpoint) {
      endpoint = (0, import_middleware_endpoint.toEndpointV1)(await (0, import_middleware_endpoint.getEndpointFromInstructions)(params, import_client_s3.PutObjectCommand, {
        ...clientConfig
      }));
    }
    if (!endpoint) {
  ...
  async __doConcurrentUpload(dataFeeder) {
    for await (const dataPart of dataFeeder) {
      ...
      const partResult = await this.client.send(new import_client_s3.UploadPartCommand({
        ...this.params,
  ...
  async __doMultipartUpload() {
    ...
    this.abortMultipartUploadCommand = null;
    if (this.tags.length) {
      await this.client.send(new import_client_s3.PutObjectTaggingCommand({
        ...this.params,
        Tagging: {
          TagSet: this.tags
        }
