...
export class GetObjectCommand extends $Command.classBuilder().ep({
  ...
  return [getSerdePlugin(config, this.serialize, this.deserialize), getEndpointPlugin(config, Command.getEndpointParameterInstructions()), getSsecPlugin(config), getS3ExpiresMiddlewarePlugin(config), getFlexibleChecksumsPlugin(config, {
    input: this.input,
