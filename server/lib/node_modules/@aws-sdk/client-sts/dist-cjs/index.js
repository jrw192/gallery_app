...
var AssumeRoleWithSAMLRequestFilterSensitiveLog = /* @__PURE__ */__name(obj => ({
  ...obj,
  ...(obj.SAMLAssertion && {
    SAMLAssertion: import_smithy_client.SENSITIVE_STRING
  })
...
var AssumeRoleWithWebIdentityRequestFilterSensitiveLog = /* @__PURE__ */__name(obj => ({
  ...
  ...(obj.WebIdentityToken && {
    WebIdentityToken: import_smithy_client.SENSITIVE_STRING
  })
...
var getCustomizableStsClientCtor = /* @__PURE__ */__name((baseCtor, customizations) => {
  var _a2;
  if (!customizations) return baseCtor;else return _a2 = class extends baseCtor {
    constructor(config) {
      super(config);
