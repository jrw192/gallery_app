...
var resolveCredentialSource = /* @__PURE__ */__name((credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    ...
    Environment: async options => {
      ...
      const {
        fromEnv
      } = await Promise.resolve().then(() => __toESM(require("@aws-sdk/credential-provider-env")));
...
var isAssumeRoleWithSourceProfile = /* @__PURE__ */__name((arg, {
  profile,
  logger
}) => {
  var _a;
...
var isCredentialSourceProfile = /* @__PURE__ */__name((arg, {
  profile,
  logger
}) => {
  var _a;
...
var resolveAssumeRoleCredentials = /* @__PURE__ */__name(async (profileName, profiles, options, visitedProfiles = {}) => {
  ...
  if (!options.roleAssumer) {
    ...
    } = await Promise.resolve().then(() => __toESM(require("@aws-sdk/client-sts")));
