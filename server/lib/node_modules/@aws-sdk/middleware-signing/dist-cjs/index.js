...
var resolveAwsAuthConfig = /* @__PURE__ */__name(input => {
  ...
  if (input.signer) {
    ...
    signer = /* @__PURE__ */__name(() => (0, import_util_middleware.normalizeProvider)(input.region)().then(async region => [(await input.regionInfoProvider(region, {
...
var normalizeCredentialProvider = /* @__PURE__ */__name(credentials => {
  if (typeof credentials === "function") {
    return (0, import_property_provider.memoize)(credentials, credentials2 => credentials2.expiration !== void 0 && credentials2.expiration.getTime() - Date.now() < CREDENTIAL_EXPIRE_WINDOW, credentials2 => credentials2.expiration !== void 0);
  }
